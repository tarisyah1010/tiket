...
<body>
    ...
    <div class="form-container">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="file" name="logo_maskapai" id="logo_maskapai" class="form-control" required>

            <label for="nama_maskapai">Nama Maskapai</label>
            <input type="text" name="nama_maskapai" id="nama_maskapai" class="form-control" placeholder="Masukkan nama maskapai" required>
